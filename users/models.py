...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(_('username'), max_length=32, unique=True ,
                                help_text= _(
                                    'Required. 30 characters or fewer starting with letters, numbers, and hyphens. ') ,
                                validators = [
...
class UserProfile(models.Model):
    ...
    province = models.ForeignKey(verbose_name=_('province'),to = 'Province' ,
                                 null = True , on_delete=models.SET_NULL)
    #email = models.EmailField(_('email address'), blank=True)
    #phone_number = models.BigIntegerField(_('phone number'), null=True, blank=True,
    #                                      validators=[
    #                                          validators.RegexValidator(r'^989[0-3,9]\d{8}$',
...
class Device(models.Model):
    ...
    device_type = models.PositiveIntegerField( choices=DEVICE_TYPES_CHOICES , default=ANDROID)
